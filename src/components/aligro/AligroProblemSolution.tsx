...
/**
 * Variante Aligro de B2BProblemSolution : structure et styles identiques,
 * mais copie en dur reformulée pour parler d'"établissement" (restaurants,
 * bars, cafés, traiteurs…) plutôt que de "restaurant/restaurateur", en
 * cohérence avec le hero Aligro. Contenu 100% en français en dur, comme le
 * reste de la page /fr/clients-aligro.
 */
const painPoints = [
  {
    icon: Eye,
    problem: {
      ...
      text: "Votre établissement est noyé parmi des milliers sur Google. Pas de photos mises en valeur, pas de carte lisible, pas de fiche qui donne envie. Les clients passent à côté.",
    },
    solution: {
      title: "Fiche professionnelle optimisée",
      text: "Une fiche professionnelle optimisée pour le SEO, avec vos photos, votre carte et vos horaires. Vous apparaissez dans les recherches locales en 5 langues — y compris pour les touristes.",
    },
  },
  {
    icon: Banknote,
    problem: {
      ...
      text: "Les plateformes à commission prennent entre 15% et 30% par commande ou réservation. Sur un article à CHF 25, vous perdez jusqu'à CHF 7.50. Ça s'accumule vite.",
    },
    solution: {
  ...
  },
  {
    ...
    solution: {
      ...
      text: "Nos avis sont vérifiés et modérés. Vous pouvez répondre à chaque avis depuis votre tableau de bord. Votre note reflète vraiment la qualité de votre établissement.",
    },
  },
] as const;

export function AligroProblemSolution() {
  return (
