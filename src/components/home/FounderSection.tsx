      ...
      <div className="mx-auto max-w-4xl">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-4 text-zinc-600 leading-relaxed">
              ...
              restaurants de Suisse Romande qui méritent d&apos;être découverts.
            </p>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          <div className="rounded-2xl bg-white p-6 text-center shadow-sm">
            ...
            <h3 className="mb-1 text-sm font-bold text-zinc-900">100% Romand</h3>
            <p className="text-xs text-zinc-600">
              Plateforme créée en Suisse Romande, pour les restaurants romands
              et les gourmands locaux.
            </p>
          </div>
          <div className="rounded-2xl bg-white p-6 text-center shadow-sm">
            <div className="mb-3 text-3xl">💬</div>
