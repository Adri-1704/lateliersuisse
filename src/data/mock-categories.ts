...
export const cuisineCategories: CuisineCategory[] = [
  ...
  { slug: "francais", nameFr: "Français", nameDe: "Franzoesisch", nameEn: "French", namePt: "Francês", nameEs: "Francés", icon: "🥐", count: 98 },
  ...
  { slug: "thai", nameFr: "Thaïlandais", nameDe: "Thailaendisch", nameEn: "Thai", namePt: "Tailandês", nameEs: "Tailandés", icon: "🍜", count: 38 },
  ...
  { slug: "americain", nameFr: "Américain", nameDe: "Amerikanisch", nameEn: "American", namePt: "Americano", nameEs: "Americano", icon: "🍔", count: 56 },
  { slug: "coreen", nameFr: "Coréen", nameDe: "Koreanisch", nameEn: "Korean", namePt: "Coreano", nameEs: "Coreano", icon: "🍱", count: 15 },
  ...
  { slug: "vegetarien", nameFr: "Végétarien", nameDe: "Vegetarisch", nameEn: "Vegetarian", namePt: "Vegetariano", nameEs: "Vegetariano", icon: "🥗", count: 34 },
  ...
  { slug: "mediterraneen", nameFr: "Méditerranéen", nameDe: "Mediterran", nameEn: "Mediterranean", namePt: "Mediterrâneo", nameEs: "Mediterraneo", icon: "🫒", count: 42 },
  { slug: "peruvien", nameFr: "Peruvien", nameDe: "Peruanisch", nameEn: "Peruvian", namePt: "Peruano", nameEs: "Peruano", icon: "🐟", count: 11 },
  { slug: "bresilien", nameFr: "Brésilien", nameDe: "Brasilianisch", nameEn: "Brazilian", namePt: "Brasileiro", nameEs: "Brasileño", icon: "🥩", count: 9 },
  ...
  { slug: "ethiopien", nameFr: "Éthiopien", nameDe: "Aethiopisch", nameEn: "Ethiopian", namePt: "Etíope", nameEs: "Etíope", icon: "🫓", count: 8 },
  ...
  { slug: "erythreen", nameFr: "Érythréen", nameDe: "Eritreisch", nameEn: "Eritrean", namePt: "Eritreu", nameEs: "Eritreo", icon: "🫓", count: 5 },
  { slug: "creole", nameFr: "Créole", nameDe: "Kreolisch", nameEn: "Creole", namePt: "Crioulo", nameEs: "Criollo", icon: "🌴", count: 8 },
  { slug: "tibetain", nameFr: "Tibétain", nameDe: "Tibetisch", nameEn: "Tibetan", namePt: "Tibetano", nameEs: "Tibetano", icon: "🥟", count: 5 },
  { slug: "bar", nameFr: "Bar & Pub", nameDe: "Bar & Pub", nameEn: "Bar & Pub", namePt: "Bar & Pub", nameEs: "Bar & Pub", icon: "🍸", count: 0 },
  { slug: "bar-a-vin", nameFr: "Bar à vin", nameDe: "Weinbar", nameEn: "Wine bar", namePt: "Bar de vinhos", nameEs: "Bar de vinos", icon: "🍷", count: 30 },
  { slug: "tea-room", nameFr: "Tea-room", nameDe: "Tea-Room", nameEn: "Tea room", namePt: "Sala de chá", nameEs: "Salón de té", icon: "🫖", count: 0 },
  { slug: "cafe", nameFr: "Café", nameDe: "Cafe", nameEn: "Cafe", namePt: "Café", nameEs: "Café", icon: "☕", count: 55 },
  { slug: "glaces", nameFr: "Glaces", nameDe: "Eisdiele", nameEn: "Ice cream", namePt: "Sorvete", nameEs: "Helados", icon: "🍦", count: 18 },
  { slug: "patisserie", nameFr: "Pâtisserie", nameDe: "Patisserie", nameEn: "Pastry shop", namePt: "Pastelaria", nameEs: "Pastelería", icon: "🧁", count: 22 },
];
