...
const mockReviews: ReviewWithRestaurant[] = [
  { id: "r1", restaurant_id: "1", author_name: "Jean Dupont", rating: 5, comment: "Excellent restaurant, service impeccable et cuisine raffinée.", is_verified: true, created_at: "2026-02-20T12:00:00Z", reply_comment: null, reply_date: null, restaurant_name: "Le Petit Prince" },
  { id: "r2", restaurant_id: "2", author_name: "Marie Curie", rating: 4, comment: "Très bonne expérience, je recommande le menu du jour.", is_verified: true, created_at: "2026-02-19T18:30:00Z", reply_comment: null, reply_date: null, restaurant_name: "Chez Marcel" },
  ...
  { id: "r5", restaurant_id: "2", author_name: "Luc Bernard", rating: 2, comment: "Déçu par la qualité, pas à la hauteur des attentes.", is_verified: false, created_at: "2026-02-16T19:45:00Z", reply_comment: null, reply_date: null, restaurant_name: "Chez Marcel" },
];
