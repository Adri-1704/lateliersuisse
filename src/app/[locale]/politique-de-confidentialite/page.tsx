...
export async function generateMetadata({
  ...
  const description = t("legalPrivacyDescription");
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        de: "/de/politique-de-confidentialite",
        en: "/en/politique-de-confidentialite",
        pt: "/pt/politique-de-confidentialite",
    ...
    openGraph: {
      title,
      description,
      url: `${baseUrl}/${locale}/politique-de-confidentialite`,
      type: "website",
    },
  };
}
