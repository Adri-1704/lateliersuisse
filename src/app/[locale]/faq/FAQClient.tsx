...
const faqs = [
  ...
  },
  {
    ...
    answerFr: "Contactez-nous directement pour obtenir le lien d'inscription. Nous proposons des abonnements mensuels, semestriels et annuels pour mettre en valeur votre établissement.",
    answerDe: "Kontaktieren Sie uns direkt, um den Registrierungslink zu erhalten. Wir bieten monatliche, halbjährliche und jährliche Abonnements an, um Ihre Einrichtung hervorzuheben.",
    answerEn: "Contact us directly to get the registration link. We offer monthly, semi-annual and annual subscriptions to showcase your establishment.",
    answerPt: "Contacte-nos diretamente para obter o link de inscrição. Oferecemos assinaturas mensais, semestrais e anuais para destacar o seu estabelecimento.",
    answerEs: "Contáctenos directamente para obtener el enlace de registro. Ofrecemos suscripciones mensuales, semestrales y anuales para destacar su establecimiento.",
  },
  {
  ...
  {
    questionFr: "Quels cantons sont couverts par Just-Tag ?",
    questionDe: "Welche Kantone deckt Just-Tag ab?",
