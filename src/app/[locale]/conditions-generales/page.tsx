...
export const metadata: Metadata = {
  title: "Conditions générales - Just-Tag.ch",
};
  ...
  const content: Record<string, { title: string; sections: { heading: string; text: string }[] }> = {
    fr: {
      ...
      sections: [
        {
          heading: "1. Objet",
          text: "Les présentes conditions générales d'utilisation (CGU) régissent l'accès et l'utilisation de la plateforme Just-Tag.ch, un annuaire en ligne de restaurants en Suisse. En accédant au site, vous acceptez sans réserve les présentes CGU.",
        },
        {
          heading: "2. Définitions",
          text: "• « Plateforme » : le site web accessible à l'adresse just-tag.ch et ses sous-domaines.\n• « Utilisateur » : toute personne accédant à la Plateforme.\n• « Restaurateur » : tout professionnel de la restauration disposant d'un compte sur la Plateforme.\n• « Contenu » : toute information, texte, image, avis ou donnée publiée sur la Plateforme.",
        },
        {
          heading: "3. Accès à la plateforme",
          text: "L'accès à la Plateforme est gratuit pour les Utilisateurs. La consultation des fiches de restaurants ne nécessite pas de création de compte. Just-Tag.ch se réserve le droit de modifier, suspendre ou interrompre tout ou partie de la Plateforme à tout moment.",
        },
        {
          heading: "4. Compte restaurateur",
          text: "Les Restaurateurs peuvent créer un compte pour gérer leur fiche d'établissement. Le Restaurateur s'engage à :\n\n• Fournir des informations exactes et à jour.\n• Maintenir la confidentialité de ses identifiants de connexion.\n• Ne pas utiliser le compte à des fins frauduleuses ou contraires à la loi.\n\nJust-Tag.ch se réserve le droit de suspendre ou supprimer un compte en cas de non-respect des présentes CGU.",
        },
        {
        ...
        },
        {
          ...
          text: "Le Restaurateur conserve la propriété de son Contenu (photos, descriptions, menus). En publiant du Contenu sur la Plateforme, le Restaurateur accorde à Just-Tag.ch une licence non exclusive, gratuite et mondiale pour afficher, reproduire et distribuer ce Contenu dans le cadre du fonctionnement de la Plateforme.\n\nLe design, le code, les logos et les éléments graphiques de Just-Tag.ch sont protégés par le droit d'auteur et ne peuvent être reproduits sans autorisation.",
        },
        {
          heading: "7. Avis des utilisateurs",
          text: "Les Utilisateurs peuvent publier des avis sur les restaurants. Ces avis doivent :\n\n• Être basés sur une expérience réelle.\n• Être respectueux et ne pas contenir de propos diffamatoires, injurieux ou discriminatoires.\n• Ne pas contenir de données personnelles de tiers.\n\nJust-Tag.ch se réserve le droit de modérer et de supprimer tout avis ne respectant pas ces règles. Les Restaurateurs peuvent répondre aux avis via leur espace client.",
        },
        {
          heading: "8. Responsabilité",
          text: "Just-Tag.ch agit en tant qu'intermédiaire technique et ne peut être tenu responsable :\n\n• De l'exactitude des informations fournies par les Restaurateurs.\n• De la qualité des prestations des restaurants référencés.\n• Des avis publiés par les Utilisateurs.\n• Des interruptions temporaires du service pour maintenance ou cas de force majeure.\n\nJust-Tag.ch s'engage à mettre en œuvre les moyens raisonnables pour assurer la disponibilité et la sécurité de la Plateforme.",
        },
        {
          heading: "9. Protection des données",
          text: "Le traitement des données personnelles est régi par notre Politique de confidentialité, accessible sur la Plateforme. Just-Tag.ch respecte la Loi fédérale sur la protection des données (LPD) et le Règlement général sur la protection des données (RGPD) pour les résidents de l'UE.",
        },
        {
        ...
        },
        {
          ...
          text: "Just-Tag.ch se réserve le droit de modifier les présentes CGU à tout moment. Les modifications prennent effet dès leur publication sur la Plateforme. L'utilisation continue de la Plateforme après modification vaut acceptation des nouvelles CGU.",
        },
        {
          heading: "12. Contact",
    ...
    de: {
      ...
      sections: [
        { heading: "1. Gegenstand", text: "Diese Allgemeinen Geschäftsbedingungen (AGB) regeln den Zugang und die Nutzung der Plattform Just-Tag.ch, einem Online-Verzeichnis von Restaurants in der Schweiz." },
        { heading: "2. Zugang", text: "Der Zugang zur Plattform ist für Benutzer kostenlos. Just-Tag.ch behält sich das Recht vor, die Plattform jederzeit zu ändern oder zu unterbrechen." },
        ...
        { heading: "4. Anwendbares Recht", text: "Diese AGB unterliegen dem Schweizer Recht. Gerichtsstand ist der Kanton Waadt, Schweiz. Kontakt: contact@just-tag.ch." },
      ],
    },
    en: {
      title: "Terms and Conditions",
      sections: [
        { heading: "1. Purpose", text: "These Terms and Conditions govern access to and use of the Just-Tag.ch platform, an online restaurant directory in Switzerland." },
        { heading: "2. Access", text: "Access to the platform is free for users. Just-Tag.ch reserves the right to modify or interrupt the platform at any time." },
        ...
        { heading: "4. Applicable Law", text: "These Terms are governed by Swiss law. Jurisdiction is the Canton of Vaud, Switzerland. Contact: contact@just-tag.ch." },
      ],
    },
  };
